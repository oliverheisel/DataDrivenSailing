...
def load_offsets(filename="/home/globaladmin/code/config/mag_offsets.json"):
    """
    ...
    try:
        ...
        logger.error("mag_load_offsets_error: could not load magnetometer offsets (using 0,0,0). error: %s", e)
        return 0, 0, 0
